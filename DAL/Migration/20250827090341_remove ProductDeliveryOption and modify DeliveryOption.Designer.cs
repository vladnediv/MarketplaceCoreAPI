...
namespace DAL.Migration
{
    ...
    [Migration("20250827090341_remove ProductDeliveryOption and modify DeliveryOption")]
    partial class removeProductDeliveryOptionandmodifyDeliveryOption
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Model.Product.ProductMedia", b =>
                {
                    ...
                    b.HasOne("Domain.Model.Product.ProductQuestion", null)
                        .WithMany("MediaFiles")
